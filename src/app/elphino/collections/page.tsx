  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#070808] text-white">
      ...
      <section aria-labelledby="collections-heading" className="elphino-collections-hero relative min-h-[760px] overflow-hidden pt-[78px] lg:min-h-[820px] lg:pt-[92px]">
        <div className="absolute inset-y-0 left-0 w-[58%] sm:w-1/2"><Image alt="Elphino printed polo development campaign" className="elphino-catalog-drift object-cover object-[57%_center]" fill loading="eager" priority sizes="50vw" src="/images/elphino/collections/polo.png" /><div className="absolute inset-0 bg-gradient-to-r from-black/5 via-black/15 to-[#070808]" /></div>
        <div className="absolute inset-y-0 right-0 hidden w-1/2 sm:block"><Image alt="Elphino graphic round neck development campaign" className="elphino-catalog-drift-alt object-cover object-[45%_center]" fill loading="eager" priority sizes="50vw" src="/images/elphino/collections/round-neck.png" /><div className="absolute inset-0 bg-gradient-to-l from-black/5 via-black/25 to-[#070808]" /></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(6,7,7,.94)_0%,rgba(6,7,7,.86)_30%,rgba(6,7,7,.18)_75%)]" />
