...
export const categoryImages: Record<ProductCategory, string> = {
  Polos: "/images/elphino/collections/polo-cotton-v2.png",
  "Round Necks": "/images/elphino/collections/round-neck-cotton-v2.png",
  Shirts: "/images/elphino/collections/shirt-cotton-v2.png",
  Hoodies: "/images/elphino/collections/hoodie-cotton-v2.png",
  Jeans: "/images/elphino/collections/jeans-cotton-v2.png",
  Trousers: "/images/elphino/collections/trousers-cotton-v2.png",
};
...
export const elphinoProducts: ElphinoProduct[] = [
  ...
  { id: "dev-shirt-01", name: "Elphino Hand-Print Cotton Shirt", category: "Shirts", style: "Printed", price: 22, colors: ["White", "Beige"], sizes: ["S", "M", "L", "XL", "XXL"], fit: "Regular", image: categoryImages.Shirts, status: "NEW", inStock: true, createdRank: 7 },
  ...
  { id: "dev-hoodie-01", name: "Elphino Artist Cotton Hoodie", category: "Hoodies", style: "Printed", price: 25, colors: ["Black", "Gray"], sizes: ["S", "M", "L", "XL"], fit: "Relaxed", image: categoryImages.Hoodies, status: "LIMITED", inStock: true, createdRank: 6 },
